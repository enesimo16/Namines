...
namespace Namines.Infrastructure.Migrations
{
    ...
    [Migration("20260919221439_AddNaminesFlowConditionsAndActions")]
    partial class AddNaminesFlowConditionsAndActions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Namines.Core.Models.Auth.CloudProject", b =>
                {
                    ...
                    b.Property<bool>("AllowDeskSql")
                        .HasColumnType("boolean");

                    b.Property<bool>("AutoApproveSafeChanges")
                        .HasColumnType("boolean");

                    b.Property<string>("ConnectionDbType")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Namines.Core.Models.Auth.CrossDatabaseRelation", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("TargetColumnId")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.ToTable("CrossDatabaseRelations");
                });

            modelBuilder.Entity("Namines.Core.Models.Auth.DeskHandoffToken", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
                    ...
                    b.ToTable("DeskHandoffTokens");
                });

            modelBuilder.Entity("Namines.Core.Models.Auth.GatewayApiKey", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Namines.Core.Models.Auth.GatewayAuditEntry", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
                    ...
                    b.ToTable("GatewayAuditEntries");
                });

            modelBuilder.Entity("Namines.Core.Models.Auth.GatewayTablePermission", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("MaskedColumns")
                        .HasColumnType("text");
                    ...
                    b.ToTable("GatewayTablePermissions");
                });
            ...
            modelBuilder.Entity("Namines.Core.Models.Auth.GroundDatabase", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
                    ...
                    b.ToTable("GroundDatabases");
                });

            modelBuilder.Entity("Namines.Core.Models.Auth.OrgAiUsage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Namines.Core.Models.Auth.SavedQuery", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Namines.Core.Models.Auth.SqlQueryHistoryEntry", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Namines.Core.Models.Auth.UsageEvent", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("UserId", "BillingPeriod", "Resource");
            ...
            modelBuilder.Entity("Namines.Core.Models.Auth.UserAIPolicy", b =>
                {
                    ...
                    b.Property<string>("AdvancedJson")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Namines.Core.Models.Auth.UserBillingSettings", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("text");
                    ...
                    b.ToTable("UserBillingSettings");
                });

            modelBuilder.Entity("Namines.Core.Models.Auth.VaultBackup", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Namines.Core.Models.Auth.VaultRestore", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("PreRestoreBackupId")
                        .HasColumnType("text");
                    ...
                    b.ToTable("VaultRestores");
                });

            modelBuilder.Entity("Namines.Core.Models.Auth.VaultSchedule", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
                    ...
                    b.ToTable("VaultSchedules");
                });

            modelBuilder.Entity("Namines.Core.Models.AutomationAction", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Namines.Core.Models.AutomationRule", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("ScopeTableId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Namines.Core.Models.AutomationRunLog", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Namines.Core.Models.Auth.CrossDatabaseRelation", b =>
                {
                    ...
                    b.HasOne("Namines.Core.Models.Auth.CloudProject", "SourceProject")
                        .WithMany()
                        .HasForeignKey("SourceProjectId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Namines.Core.Models.Auth.CloudProject", "TargetProject")
                        .WithMany()
            ...
            modelBuilder.Entity("Namines.Core.Models.AutomationAction", b =>
                {
                    b.HasOne("Namines.Core.Models.AutomationRule", null)
                        .WithMany("Actions")
            ...
            modelBuilder.Entity("Namines.Core.Models.AutomationRule", b =>
                {
                    b.HasOne("Namines.Core.Models.Auth.CloudProject", null)
                        .WithMany()
                        .HasForeignKey("ProjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
