        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NodePositionsJson = table.Column<string>(type: "text", nullable: false),
                    UserId = table.Column<string>(type: "text", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CloudProjects", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CloudProjects_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UserId = table.Column<string>(type: "text", nullable: false),
                    SmartSeed = table.Column<int>(type: "integer", nullable: false),
                    Documentation = table.Column<int>(type: "integer", nullable: false),
                    Scaffolding = table.Column<int>(type: "integer", nullable: false),
                    SchemaGeneration = table.Column<int>(type: "integer", nullable: false),
                    SchemaRevision = table.Column<int>(type: "integer", nullable: false),
                    DbaAnalysis = table.Column<int>(type: "integer", nullable: false),
                    Migration = table.Column<int>(type: "integer", nullable: false),
                    Voice = table.Column<int>(type: "integer", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserAIPolicies", x => x.UserId);
                    table.ForeignKey(
                        name: "FK_UserAIPolicies_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
