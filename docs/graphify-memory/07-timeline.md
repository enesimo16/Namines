...
- **2026-09-26** — Bütün belgeler koddan doğrulandı, bitenlerin altına "bitmiştir" notu düşüldü; `CHECKLIST.md`'ye G55 eklendi. Docker ve disk engelleri kalkmış bulundu; B-12 (MSSQL + Oracle FK okuması) gerçek motorlara karşı doğrulanıp kapandı; yol boyunca MSSQL identity, Oracle para kolonlarının INT okunması (küsurat kaybı) ve Oracle sayısal uzunluk hataları düzeltildi. Backend 2082/2082, frontend 188, Desk 101.
