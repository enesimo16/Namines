      ...
      <Tooltip.Root>
        ...
        <Tooltip.Portal>
          <Tooltip.Content
            ...
            align="center"
            sideOffset={6}
            className="z-[9999] max-w-[280px] bg-surface-800 border border-content-primary/12 text-content-primary p-3.5 rounded-xl shadow-[0_20px_60px_rgba(0,0,0,0.6)] animate-in fade-in slide-in-from-bottom-2 duration-150 text-xs leading-relaxed font-sans"
          >
